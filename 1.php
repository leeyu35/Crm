...
<body>
<div class="container" >
<h3>新增客户<small>New Customer</small></h3>
<br>
<form action="{:U('addru')}" method="post" class="form-horizontal" >
<h4>客户基本信息</h4>
<hr>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10 text-left">
       <volist id="product_line_list" name="product_line_list" key="k">
        <label class="checkbox-inline"  {$k=='1'?'style="margin-left:10px"':''}><input name="product_line[]" type="checkbox" id="inlineCheckbox1" value="{$product_line_list.id}">{$product_line_list.name}</label>
       </volist>
