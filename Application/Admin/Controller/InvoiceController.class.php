...
class InvoiceController extends CommonController
{
        public function index(){
           ...
           // echo $q_where;
            ...
            $sum =$Refund->field('a.id,a.invoice_head,a.contract_no,a.money,a.ctime,a.audit_1,a.audit_2,b.advertiser')->join("a left join __CUSTOMER__ b on a.invoice_head = b.id ")->where("a.id!='0' and ".$q_where.$where)->sum("a.money");// 查询满足要求的总记录数
            $this->sum=$sum;
