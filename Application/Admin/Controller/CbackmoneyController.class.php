...
class CbackmoneyController extends CommonController
{
        public function index(){
            ...
            $list=$Diankuan->field('a.id,a.advertiser as aid,a.appname,a.advertiser,a.b_money,a.b_time,a.ctime,a.submituser,b.advertiser,a.audit_1,a.audit_2')->join("a left join __CUSTOMER__ b on a.advertiser = b.id ")->where("a.id!='0'  and ".$q_where.$where)->limit($Page->firstRow.','.$Page->listRows)->order("a.ctime desc")->select();
    ...
    public function fp_huikuan($id){
        ...
        $contract_list=$contract->where("advertiser=$id and iszuoei=0")->select();
