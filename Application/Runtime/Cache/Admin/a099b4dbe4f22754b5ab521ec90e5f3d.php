...
<div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
    <label  class="control-label"><strong><?php echo ($info[type2]==1?'专票':''); echo ($info[type2]==2?'普票':''); ?></strong></label>
    </div>
       	<label for="inputEmail3" class="col-sm-1 control-label">是否跨月</label>
    <div class="col-sm-3">
        <label  class="control-label"><strong><?php echo ($info[is_kuayue]==0?'本月':''); echo ($info[is_kuayue]==1?'跨月':''); ?></strong></label>
    </div>
   ...
   <div class="form-group" id="isrenzhen"  <?php echo ($info[type2]==1?'style="display:block;"':'style="display:none;"'); ?>>
    ...
    <div class="col-sm-3">
    <label  class="control-label"><strong><?php echo ($info[is_renzheng]==0?'未认证':''); echo ($info[is_renzheng]==1?'已认证':''); ?></strong></label>
    </div>
