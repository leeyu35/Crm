...
<script type="text/javascript" src="../../../Public/js/javascripts/simple-calendar.js"></script>
    ...
    <style>
		...
		.ring_2{width:36%; float:right;  margin-top:50px; margin-right:6.5%;  background: #f5f5f5; box-shadow: 0px 2px 10px #999999;}
    </style>
</head>
<body>
...
<div class="people" style="overflow:hidden;" >
    <div class="clear" style="margin-top:25px;">
        <div class="touxiang">
            <p>
                <img src="<?php echo (session('u_image')); ?>" width="100" height="100" class="img-circle" />
            </p>
...
<br>
    ...
    <div class="ring_2">
    	<div style="padding:10px;"><h2>三人行必有我师焉</h2></div>
    </div>
    </div>
