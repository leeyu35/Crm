...
<head lang="en">
	...
	$(document).ready(function(e) {
		...
		$(".client>li").click(function(){
			...
			iformurl="<?php echo U('Public/jiazai');?>";
			$("#frame").attr("src",iformurl);
...
<div class="title clear">
    <div style="float: left">
        <a href="<?php echo U("Admin/Index/index");?>" class="logo"><span style="margin-left: 30px; display:block;" class="logo">
        CRM管理控制台
        </span></a>
    </div>
...
<div class="clear" style="height:95%;">
    ...
    <div class="toc">
        ...
        <div class="li2">
            ...
            <div class="liebiao" id="<?php echo U('Renew/index2?shenhe=k');?>">
                <a >续费列表</a>
            </div>
        </div>
        <div class="li3">
        ...
        <div class="li6">
            ...
            <div class="liebiao" id="<?php echo U('Set/index');?>" >
                <a>系统设置</a>
            </div>
        </div>
        <div class="li7">
