...
<hr>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
    	<input id="contract_start" class="Wdate form-control" type="text" value="<?php echo (date('Y-m-d',$info[contract_start])); ?>" name="contract_start"  onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'contract_end\')||\'2020-10-01\'}'})" /> 
    </div>
        <div class="col-sm-2">
<input id="contract_end" class="Wdate form-control" type="text" value="<?php echo (date('Y-m-d',$info[contract_end])); ?>"  name="contract_end" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'contract_start\')}',maxDate:'2020-10-01'})" />
    </div>
