...
<h4 class="bor-left-bull" >外出详细信息</h4>
<hr>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
     	<label  class="control-label"><strong><?php echo ($info[gongsi]); ?></strong></label>
    </div>
    
    <label for="contract_money" class="col-sm-1 control-label">联系人</label>
    <div class="col-sm-2">
     	<label  class="control-label"><strong><?php echo ($info[lianxiren]); ?></strong></label>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
     	<label  class="control-label"><strong><?php echo ($info[dizhi]); ?></strong></label>
    </div>
