...
<table class="table table-hover  table-striped">
    ...
    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($k % 2 );++$k;?><tr>
    	...
    	<td><?php echo ($list[manager]==0?'不是':'是'); ?></td>
    	<td><?php echo (date("Y-m-d",$list[ctime])); ?></td>
    	<td><a href="<?php echo U("updata?id=$list[id]");?>"  data-toggle="tooltip" data-placement="left" title="修改" ><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo U("delete?id=$list[id]");?>"  <?php echo ($confirm); ?>  data-toggle="tooltip" data-placement="left"  title="删除"><span class="glyphicon glyphicon-trash"></span></a></td>
